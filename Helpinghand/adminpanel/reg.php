...
$date=date("Y-m-d");
  ...
  $selectquery="SELECT * FROM ashaworkers_admin where email='$email' or phoneno='$phoneno'";
  ...
  else 
  {
    ...
    {
    $insertquery= "INSERT INTO ashaworkers_admin(userid,fname,lname,email,phoneno,password,repeatpassword,district,mandal,wardno,date,city) VALUES('$userid','$fname','$lname','$email','$phoneno','$pass','$repass','$district','$mandal','$wardno','$date','$city')";
