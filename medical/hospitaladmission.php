...

{
  ...
  if (empty($_POST['state']) || empty($_POST['gender']) || empty($_POST['service']) || empty($_POST['choose']) || empty($_POST['oppdate'])  || empty($_POST['timeslot']) || empty($_POST['travelhistory'])  || empty($_POST['symptoms']) || empty($_POST['zone']) )
...
$choose=mysqli_real_escape_string($dbconnect,$_POST['choose']);
$oppdate=mysqli_real_escape_string($dbconnect,$_POST['oppdate']);
$timeslot=mysqli_real_escape_string($dbconnect,$_POST['timeslot']);
$v1=rand(1111,9999);
$v2=rand(1111,9999);
$v3=$v1.$v2;
$v3=md5($v3);
...
move_uploaded_file($_FILES["document"]["tmp_name"],$dst2);
 ...
 $insertquery="INSERT INTO medicare_hospitaladmission(regno,name,email,phoneno,adhaarno,age,gender,state,city,address,landmark,pincode,service,symptoms,travelhistory,choose,oppdate,timeslot,image,document,date) VALUES('$regno','$name','$email','$phoneno','$adhaarno','$age','$gender','$state','$city','$address','$landmark','$pincode','$service','$symptoms','$travelhistory','$choose','$oppdate','$timeslot','$dst1','$dst3','$date')";
...
<html lang="en">
 ...
 <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/css/all.min.css" rel="stylesheet">
   ...
   <div class="row justify-content-center">
    <div class="col-md-10">
      ...
      <div class="card mt-5 border border-success">
       ...
       <u><h5 class="text-center">Hospital Admission</h5></u>
        <div class="card-body">
        ...
        <div class="alert alert-secondary mt-3" role="alert">
           <h5 class="text-center"><i class="fas fa-procedures"></i></span> Hospital Admission</h5>
          </div>
  ...
  <select class="form-control" name="service">
    <option value="" selected disabled>Select</option>
    <option>Emergency Operation</option>
    <option>Isolation(covid-19)</option>
  ...
  <label>Choose:</label>
   <select class="form-control" name="choose">
    <option value="" selected disabled>Select</option>
    <option>Surgical Operation</option>
    <option>Laser Operation</option>
   ...
   <div class="row mt-2">
          <div class="col-lg-6">
           <label>Operation/isolation Date:</label>
  <input type="Date" class="form-control" value="" placeholder="Name" id="" name="oppdate" >
    
  </div>
  <div class="col-lg-6">
  <label>Operation Time Slot:</label>
