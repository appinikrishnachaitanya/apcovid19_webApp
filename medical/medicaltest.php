...
{ 
  ...
  if (empty($_POST['gender']) || empty($_POST['testtype']) || empty($_POST['symptoms']) || empty($_POST['testdate']) || empty($_POST['testslot']) || empty($_POST['travelhistory']) || empty($_POST['zone']) || empty($_POST['labname']) || empty($_POST['state'])  )
  {
  ...
  $regno=$var1.$var5.$var2.$var3.$var4.$var6;
  $date=date("Y-m-d");
      ...
      $testtype=mysqli_real_escape_string($dbconnect,$_POST['testtype']);
      $labname=mysqli_real_escape_string($dbconnect,$_POST['labname']);
      ...
      $testdate=mysqli_real_escape_string($dbconnect,$_POST['testdate']);
      $testslot=mysqli_real_escape_string($dbconnect,$_POST['testslot']);
      $v1=rand(1111,9999);
$v2=rand(1111,9999);
$v3=$v1.$v2;
$v3=md5($v3);
...
move_uploaded_file($_FILES["document"]["tmp_name"],$dst2);
 ...
 $insertquery="INSERT INTO medicare_medicaltest(regno,name,email,phoneno,adhaarno,age,gender,state,city,address,landmark,pincode,testtype,symptoms,travelhistory,labname,testdate,testslot,image,document,date) VALUES('$regno','$name','$email','$phoneno','$adhaarno','$age','$gender','$state','$city','$address','$landmark','$pincode','$testtype','$symptoms','$travelhistory','$labname','$testdate','$testslot','$dst1','$dst3','$date')";
...
<html lang="en">
   ...
   <div class="row justify-content-center">
    <div class="col-md-10">
      ...
      <div class="card mt-5 border border-success">
       ...
       <u><h5 class="text-center">Book For A Medical TEST</h5></u>
        <div class="card-body">
        ...
        <div class="alert alert-secondary mt-3" role="alert">
           <h5 class="text-center"><i class="fas fa-notes-medical"></i></span> Medical Test</h5>
          </div>
  ...
  <select class="form-control" name="testtype">
    ...
    <option>Particular Test(Doctor Prescription)</option>
  ...
  <label>Select Lab</label>
   <select class="form-control" name="labname">
    <option value="" selected disabled>Select</option>
    <option>LAB-A</option>
    <option>LAB-B</option>
  ...
  <input type="Date" class="form-control" value="" placeholder="Name" id="" name="testdate" >
    
  </div>
  <div class="col-lg-6">
  <label>Test Slot:</label>
  <select class="form-control" name="testslot">
    <option value="" selected disabled>Select</option>
    <option>10AM</option>
    <option>12PM</option>
    <option>2PM</option>
