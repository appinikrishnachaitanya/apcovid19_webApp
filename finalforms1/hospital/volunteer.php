...
if ($_SERVER["REQUEST_METHOD"]=="POST")
{
  ...
  $hospitaltype=mysqli_real_escape_string($dbconnect,$_POST['hospitaltype']);
  $phoneno2=mysqli_real_escape_string($dbconnect,$_POST['phoneno2']);
  $accomidation=mysqli_real_escape_string($dbconnect,$_POST['accomidation']);


  $insertquery="INSERT INTO helpinghands_speakers(name,email,phoneno,adhaarno,state,mandal,district,city,address,provider,pincode,zone,opentime,closetime,hospitaltype,phoneno2,accomidation) VALUES('$name','$email','$phoneno2','$adhaarno','$state','$mandal','$district','$city','$address','$provider
    ','$pincode','$zone','$opentime','$closetime','$hospitaltype','$phoneno','$accomidation')";
...
<html lang="en">
    ...
    <div class="col">
      ...
      <div class="card border border-success">
        <div class="alert alert-info" role="alert">
         <h5 class="text-center ">Hospitals care</h5>
      </div>
        <div class="card-body">
 ...
 <input type="number" class="form-control " id="phone" placeholder="9098791234" name="phoneno2"  required>
          ...
          <div class="alert alert-secondary mt-3" role="alert">
           <h5 class="text-center"><span><i class="far fa-map"></i></span> Hospital Address</h5>
          </div>
         ...
         <input type="text" class="form-control " id="add" placeholder="XXXX" name="address"  required>
          ...
          <div class="col-lg-6">
         <label for="lmark">Name of The Hospital:<span style="color: red;">*</span></label>
          <div class="input-group mb-2">
          <div class="input-group-prepend">
          <div class="input-group-text"><i class="far fa-map"></i></div>
         </div>
 ...
 <input type="text" class="form-control " id="lmark" placeholder="XXXX" name="closetime"  required>
   ...
   <div class="row mb-3">
     <div class="col-lg-6">
    <label for="lmark">Beds:<span style="color: red;">*</span></label>
     <div class="input-group mb-2">
     <div class="input-group-prepend">
     <div class="input-group-text"><i class="far fa-map"></i></div>
    </div>
    <input type="text" class="form-control " id="lmark" placeholder="XXXX" name="accomidation"  required>
    </div>
   </div>
  <div class="col-lg-6">
   <label>Covid Hospital</label>
