...
if ($_SERVER["REQUEST_METHOD"]=="POST")
{
  ...
  $accommodation=mysqli_real_escape_string($dbconnect,$_POST['accommodation']);
  $shelter=mysqli_real_escape_string($dbconnect,$_POST['shelter']);
  $phoneno2=mysqli_real_escape_string($dbconnect,$_POST['phoneno2']);

  $insertquery="INSERT INTO helpinghands_doctors(name,email,phoneno,adhaarno,state,mandal,district,city,address,provider,pincode,zone,fromdate,todate,accommodation,shelter,phoneno2) VALUES('$name','$email','$phoneno','$adhaarno','$state','$mandal','$district','$city','$address','$provider','$pincode
    ','$zone','$fromdate','$todate','$accommodation','$shelter','$phoneno2')";
    ...
    <div class="col">
      ...
      <div class="card border border-success">
        <div class="alert alert-info" role="alert">
         <h5 class="text-center ">Be a Shelter Provider</h5>
      </div>
        <div class="card-body">
...
<div class="row mt-2">
         ...
         <input type="number" class="form-control " id="phone" placeholder="9098791234" name="phoneno2"  required>
          ...
          <div class="alert alert-secondary mt-3" role="alert">
           <h5 class="text-center"><span><i class="far fa-map"></i></span> Shelter Address</h5>
          </div>
         ...
         <input type="text" class="form-control " id="add" placeholder="XXXX" name="address"  required>
          ...
          <div class="col-lg-6">
         <label for="lmark">Name of The Shelter:<span style="color: red;">*</span></label>
          <div class="input-group mb-2">
          <div class="input-group-prepend">
          <div class="input-group-text"><i class="far fa-map"></i></div>
         </div>
  ...
  <div class="alert alert-secondary mt-3" role="alert">
       ...
       <h5 class="text-center">sheltering Details</h5>
  ...
  <label for="add">From Date:<span style="color: red;">*</span></label>
  <div class="input-group mb-2">
  <div class="input-group-prepend">
  <div class="input-group-text"><i class="fas fa-map-marker-alt"></i></div>
 </div>
 <input type="text" class="form-control " id="add" placeholder="XXXX" name="fromdate"  required>
 </div>
</div>

  <div class="col-lg-6">
 <label for="lmark">To Date:<span style="color: red;">*</span></label>
  <div class="input-group mb-2">
  <div class="input-group-prepend">
  <div class="input-group-text"><i class="far fa-map"></i></div>
 </div>
 <input type="text" class="form-control " id="lmark" placeholder="XXXX" name="todate"  required>
 </div>
</div>
</div>
   ...
   <div class="row mb-3">
     <div class="col-lg-6">
    <label for="lmark">Number Of Members To Give Shelter<span style="color: red;">*</span></label>
     <div class="input-group mb-2">
     <div class="input-group-prepend">
     <div class="input-group-text"><i class="far fa-map"></i></div>
    </div>
    <input type="text" class="form-control " id="lmark" placeholder="XXXX" name="shelter"  required>
    </div>
   </div>
  <div class="col-lg-6">
